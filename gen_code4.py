...
#         print(rule)
# print(rules_lookup)
# for line in rules_lookup:
#     print(rules_lookup[line],line)
print("RULES_LOOKUP:")
for line in rules_lookup:
    print(line,rules_lookup[line])
print("RULE_COUNTS:")
for line in rule_counts:
    print(line) 
# print()
# print(grammar)
# print(rules_lookup[("NP")])

# print()
# print()
# print(grammar[('NP', 'NP_NN')])
# print(rules_lookup[('NP', 'NP_NN')])
# print(rules_lookup[('NP', 'NP_NN')])
print("GRAMMAR:")
for rule in grammar:
    print(rule)
                ...
                for rule in grammar:
                    ...
                    for RHS1 in target1:
                        ...
                        #print("We matched: ", rule[0])
                                ...
                                #extra checking to see if new tag is a RHS of a rule
                                for item in grammar:
                                    if item[1] == rule[0]:
                                        print(item)
                                        print()
...
with open("dev.strings") as file:
    ...
    sample_tree = trees.Tree.from_str(s)
    print(sample_tree.pretty_print())
    # print(sent)
    sent = sent.strip()
    print(sent)
